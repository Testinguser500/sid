...
<div class="box box-primary" ng-if="page=='edit'">
            ...
            <!-- form start -->
                 ...
                 {{ csrf_field() }}
                  <input type="hidden" class="form-control" id="" name="user_id" ng-model="user.id" placeholder="Name" value="<% user.id %>">
              <div class="box-body">
			 <div class="form-group col-xs-4">
                  <label for="exampleInputEmail1">Username</label>
                  <input type="text" class="form-control" id="" name="name" ng-model="user.username"  placeholder="Name" value="<% user.username %>">
