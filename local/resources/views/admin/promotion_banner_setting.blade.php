             ...
             <div class="form-group">
              <label class="control-label col-sm-2" for="pwd">Enable/Disable</label>
               <div class="col-sm-10">
                  ...
                  <div class="box-body" ng-show="set_data == true">    
            <div class="col-sm-12 main--tab">   
                ...
                <div class="col-sm-8">
                    <div class="jumbotron">
                        <div ng-show="isSet(1)">
                             <div class="form-group">
                                    <label class="control-label col-sm-4" for="pwd">Create Package</label>
                                     <div class="col-sm-8">
                                       <%  setting_data.create_package %>
                                       <div ng-repeat="creat_pkg in setting_data.create_package">
                                         <div class="col-sm-5"  >
                                               <input class="form-control" type="text" id="inlineCheckbox1" value="" ng-model="setting_data.create_package[$index].field_value">
                                           </div>
                                            <div class="col-sm-5">
                                                <input class="form-control" type="text" id="inlineCheckbox1" value="" ng-model="setting_data.create_package[$index].field_value">
                                           </div>
